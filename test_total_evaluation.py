...
if __name__ == "__main__":
    ...
    feature_data_path = r"E:\sdmurmur\ssdHeartMurmurFiles\band_filter_800Hz\test_TTF_TDF_MV_cz_feature"
    fold_path = feature_data_path
    feature_path = os.path.join(fold_path, 'feature')
    # 模型路径
    model_folder = r'E:\sdmurmur\ssdHeartMurmurFiles\band_filter_800Hz\train_result_12_31\model'  # 存储模型的文件夹
    # 时频域特征+时域特征模型
    ...
    model_result_path = r"E:\sdmurmur\ssdHeartMurmurFiles\band_filter_800Hz\test_result_12_31"
    # 设置环境变量，指定可见的 GPU 设备
