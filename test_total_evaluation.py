...
if __name__ == "__main__":
    ...
    feature_data_path = r"E:\sdmurmur\ssdHeartMurmurFiles\S1S2Experiment\test_scale\test_mask_s2_feature"
    fold_path = feature_data_path
    feature_path = os.path.join(fold_path, 'feature')
    # 单时频特征模型
    model_folder = r'E:\sdmurmur\ssdHeartMurmurFiles\S1S2Experiment\train_result_s1s2\TF_TDFMV_mask_s2_1_1_1_12\model'  # 存储模型的文件夹
    # 时频域特征+时域特征模型
    ...
    model_result_path = r"E:\sdmurmur\ssdHeartMurmurFiles\S1S2Experiment\test_result_s1s2\TF_TDFMV_mask_s2_1_1_1_12"
    # 设置环境变量，指定可见的 GPU 设备
