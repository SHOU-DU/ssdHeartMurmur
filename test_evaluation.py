...
if __name__ == "__main__":
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\TF_ODConv_k3\feature_TF_TDF_60Hz_cut_zero'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        model_result_path = os.path.join('test_result_odc_tf_1_1_1', fold_path, str(j)+'_fold')
        # 设置环境变量，指定可见的 GPU 设备
