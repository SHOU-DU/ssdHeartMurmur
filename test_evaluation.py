...
if __name__ == "__main__":
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\mask\TF_ODC_k3_15_15_es_5_005'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        mask_test_model_path = r'E:\sdmurmur\ssdHeartMurmur\mask\test_TF_ODC_k3_15_15_es_5_005_loss'  # 保存测试结果的路径
