...
if __name__ == "__main__":
    ...
    feature_data_path = r"E:\sdmurmur\ssdHeartMurmur\S1S2Experiment\test_mask_s2_feature"  # AMG模型提取的特征和标签文件夹
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\train_vali_new_results\TF_AMG_FocalLoss_1_1_1_old_128'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        mask_test_model_path = r'E:\sdmurmur\ssdHeartMurmur\S1S2Experiment\test_result_s1s2\TF_AMG_FocalLoss_1_1_1_old_128'  # 保存测试结果的路径
