...
if __name__ == "__main__":
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\early_stop\TF_ODC_k3_001_64_150_lr_ step'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        mask_test_model_path = r'E:\sdmurmur\ssdHeartMurmur\early_stop\test_TF_ODC_k3_001_64_150_lr_ step'  # 保存测试结果的路径
