...
if __name__ == "__main__":
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\dropout\TF_ODC_k3'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        CB_Loss_test_model_path = r'E:\sdmurmur\ssdHeartMurmur\dropout\test_TF_ODC_k3'  # 保存测试结果的路径
