...
if __name__ == "__main__":
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\CBloss\TF_ODC_k3_b_999'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        CB_Loss_test_model_path = r'E:\sdmurmur\ssdHeartMurmur\CBloss\test_TF_ODC_k3_b_999'
