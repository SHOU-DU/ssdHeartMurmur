...
if __name__ == "__main__":
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\train_vali_new_results\TF_TDFMV_FocalLoss_1_1_1_old_135'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        mask_test_model_path = r'E:\sdmurmur\ssdHeartMurmur\test_result_new\TF_TDFMV_FocalLoss_1_1_1_old_135'  # 保存测试结果的路径
