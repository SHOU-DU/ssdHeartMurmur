...
if __name__ == "__main__":
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\mask\TF_TDF_ODC_k3_cat133_15_15_es_5_005'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        # 加载模型
        model = torch.load(os.path.join(model_path, 'es_model'))
        # 采用最后一轮的模型进行评估
        ...
        mask_test_model_path = r'E:\sdmurmur\ssdHeartMurmur\mask\test_TF_TDF_ODC_k3_cat133_15_15_es_5_005'  # 保存测试结果的路径
