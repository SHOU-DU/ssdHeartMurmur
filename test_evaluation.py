...
if __name__ == "__main__":
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\train_vali_new_results\CBLoss\TF_TDFMVCST_CBLoss_b_09_old_192'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        mask_test_model_path = r'E:\sdmurmur\ssdHeartMurmur\test_result_new\CBLoss\TF_TDFMVCST_CBLoss_b_09_old_192'  # 保存测试结果的路径
