...
if __name__ == "__main__":
    ...
    feature_data_path = r"E:\sdmurmur\ssdHeartMurmur\S1S2Experiment\test_scale\test_mask_s1s2_feature"  # 模型提取的特征和标签文件夹
    ...
    model_folder = r'E:\sdmurmur\ssdHeartMurmur\S1S2Experiment\train_result_s1s2\vali_TF_TDFMV_mask_s1s2_1_1_1'  # 存储模型的文件夹
    ...
    for j in range(kfold):
        ...
        mask_test_model_path = r'E:\sdmurmur\ssdHeartMurmur\S1S2Experiment\test_result_s1s2\vali_TF_TDFMV_mask_s1s2_1_1_1'  # 保存测试结果的路径
