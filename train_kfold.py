...
if __name__ == "__main__":
    ...
    for i in range(kfold):
        ...
        CBloss_model_path = r'E:\sdmurmur\ssdHeartMurmur\all_data_results\TF_SK_FocalLoss_4_3_3_old_128'
        ...
        weight = torch.tensor([0.4, 0.3, 0.3]).to(device)  # sd 改变权重值，增加loud权重
