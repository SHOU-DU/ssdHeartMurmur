...
if __name__ == "__main__":
    ...
    for i in range(kfold):
        ...
        feature_data_path = r'E:\sdmurmur\ssdHeartMurmur\S1S2Experiment\vali_scale\vali_mask_s1s2_feature'
        ...
        cut_data_kfold = r'E:\sdmurmur\ssdHeartMurmur\S1S2Experiment\vali_scale\vali_mask_s1s2'
        if not test_flag:
        ...
        CBloss_model_path = r'E:\sdmurmur\ssdHeartMurmur\S1S2Experiment\train_result_s1s2\vali_TF_TDFMV_mask_s1s2_1_1_1'
        # CBloss_model_path = r'E:\sdmurmur\ssdHeartMurmur\train_vali_new_results\TF_TDFMV_mask_s1_1_1_1'
        ...
        for epoch in range(num_epochs):
            ...
            if epoch >= 15:
                ...
                if loss_metric < best_val_loss:
                    ...
                    min_loss_epoch = float('nan')  # 最小loss>1则不保存模型
