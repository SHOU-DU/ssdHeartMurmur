...
if __name__ == "__main__":
    ...
    for i in range(kfold):
        ...
        # model_result_path = os.path.join('all_data_TF_MFCC_TDFMVCST_ODC_k3_MM_withoutMFCC_FCCat144_1_1_1_MV', fold_path)
        model_result_path = os.path.join('all_data_TF_ODConv_k3_weight_3_3_4', fold_path)
