...
def save_test_feature(train_folder, train_tdf_folder, train_feature_folder):
    ...
    train_feature = Log_GF_TDF_CST_MV_MFCC(train_folder, train_tdf_folder)
...
if __name__ == '__main__':
    # 特征提取
    kfold_festure_in = "data_kfold_cut_zero_total"  # test set切割好的数据，对于present个体，只复制murmur存在的.wav文件
    kfold_feature_folder = "train_total_feature_TF_TDF_60Hz_cut_zero"  # 存储每折特征文件夹
    tdf_feature_folder = r"E:\sdmurmur\traintotalEnvelopeandSE60Hz"  # 时域特征存储文件夹
