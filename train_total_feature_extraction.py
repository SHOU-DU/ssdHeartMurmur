...
def save_test_feature(train_folder, train_tdf_folder, train_feature_folder):
    ...
    train_feature = Log_GF_TDF_MV(train_folder, train_tdf_folder)
...
if __name__ == '__main__':
    ...
    kfold_feature_in = r"E:\sdmurmur\ssdHeartMurmurFiles\S1S2Experiment\train_vali_mixed_scale\train_vali_double_s1"
    # 特征输出文件夹
    kfold_feature_folder = r"E:\sdmurmur\ssdHeartMurmurFiles\normalized_S1S2Experiment\train_vali_mixed_scale\double_s1_feature"
    # 时域特征存储文件夹
    tdf_feature_folder = r"E:\sdmurmur\ssdHeartMurmurFiles\normalized_S1S2Experiment\train_vali_mixed_scale\double_s1_EnvelopeandSE60Hz"
